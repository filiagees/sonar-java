...
public class TextBlocksInComplexExpressionsCheck extends IssuableSubscriptionVisitor {
  ...
  private static final String MASSAGE = "Refactor this text block to a local variable or a static final field.";
  ...
  public void visitNode(Tree tree) {
    ...
    finder.misusedTextBlocks.forEach(textBlock -> reportIssue(textBlock, MASSAGE));
  }
